...
> Os títulos **"Lendas"**, **"Lendas de Poder e Magia"** e **"Demanda das Runas"** (este último usado em uma tradução da edição anterior) são designados como **Identidade do Produto** nos termos das seções 1(e), 1(f) e 7 da OGL, e não podem ser usados, quer seja comercial ou gratuitamente, nem mesmo para indicar compatibilidade.
...
## Logotipo de Compatibilidade com Legend

Todo o texto do RPG Legend é designado como Conteúdo de Jogo Aberto (_Open Game Content_), assim como todo o texto de todos os livros desta linha com capas de cor lisa e com as palavras "... of Legend" em seus títulos.

Ao utilizar qualquer material de Conteúdo Aberto em qualquer um desses livros, você também tem permissão para usar livremente o logotipo "Legend Compatible" em qualquer publicação ou site onde esse Conteúdo Aberto seja usado ou modificado. O logotipo "Legend Compatible" pode ser redimensionado, mas não pode ser alterado de nenhuma outra forma.

Legend, o texto dos livros de regras de Legend, o logotipo Legend e o logotipo Legend Compatible permanecem sob Copyright da Mongoose Publishing 2011.

Toda a arte incluída nos livros de regras de Legend é expressamente designada como não sendo Conteúdo Aberto, não podendo ser utilizada sem autorização por escrito da Mongoose Publishing.
